"""
Django settings for arches_workflow_stepper project.
"""
...
APP_NAME = "arches_workflow_stepper"
...
DATATYPE_LOCATIONS.append("arches_workflow_stepper.datatypes")
FUNCTION_LOCATIONS.append("arches_workflow_stepper.functions")
ETL_MODULE_LOCATIONS.append("arches_workflow_stepper.etl_modules")
SEARCH_COMPONENT_LOCATIONS.append("arches_workflow_stepper.search_components")
...
SECRET_KEY = "django-insecure-dsl!1y(y_x(z3(@$ne@co(elq9-uz46j6+#nil!j(4h-lvr2)d"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = "arches_workflow_stepper.urls"
ROOT_HOSTCONF = "arches_workflow_stepper.hosts"

DEFAULT_HOST = "arches_workflow_stepper"
...
ELASTICSEARCH_PREFIX = "arches_workflow_stepper"

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'arches_workflow_stepper.search_indexes.sample_index.SampleIndex',
...
INSTALLED_APPS = (
    ...
    "pgtrigger",
    # "silk",
    "arches_workflow_stepper",  # Ensure the project is listed before any other arches applications
)
...
WSGI_APPLICATION = "arches_workflow_stepper.wsgi.application"
...
SESSION_COOKIE_NAME = "arches_workflow_stepper"
...
# ES_MAPPING_MODIFIER_CLASSES = ["arches_workflow_stepper.search.es_mapping_modifier.EsMappingModifier"]
