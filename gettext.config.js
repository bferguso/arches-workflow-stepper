...
module.exports = {
  input: {
    path: "./arches_workflow_stepper/src", // only files in this directory are considered for extraction
  ...
  output: {
    path: "./arches_workflow_stepper/locale", // output path of all created files
